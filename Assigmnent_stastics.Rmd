...
shopping_data = as.matrix(read.csv(file="D:/anjana_pc/softwarica_masters/Stats assigm/Samples and datasets/customer_shopping_data.csv",header = TRUE))
head(shopping_data)
```
...
lines(density_of_price, lwd = 2, col = "blue")
rug(jitter(x$price))
```
```{r}
density_of_payment = density(x$payment_method)
plot(density_of_payment,main = "Density plot of whole inputs payment")
# creating  a Histogram of X inputs
hist(x$payment_method,freq = FALSE,main = "Histogram and density plot of payment",xlab = "payment_method")
lines(density_of_payment, lwd = 2, col = "blue")
...
plot(density_of_age,main = "Density plot of whole inputs age")
# creating  a Histogram of X inputs
hist(x$age,freq = FALSE,main = "Histogram and density plot of age",xlab = "age")
lines(density_of_age, lwd = 2, col = "blue")
rug(jitter(x$age))
```
```{r}
...
plot(density_of_category,main = "Density plot of whole inputs category")
# creating  a Histogram of X inputs
hist(x$category,freq = FALSE,main = "Histogram and density plot of category",xlab = "category")
lines(density_of_category, lwd = 2, col = "blue")
rug(jitter(x$category))
```
```{r}
density_of_quantity = density(shopping_data$quantity)

plot(density_of_quantity,main = "Density plot of whole inputs quantity")
# creating  a Histogram of X inputs
hist(shopping_data$quantity,freq = FALSE,main = "Histogram and density plot of quantity",xlab = "quantity")
lines(density_of_quantity, lwd = 2, col = "blue")
...
plot(x$payment_method,Y,main = "Correlation between payment method and quantity signal",xlab = "payment_method",ylab = "quantity")




# Correlation between age and quantity
cor_age_quantity <- cor(x$age, Y)
print(paste("Correlation between age and quantity:", cor_age_quantity))

# Correlation between price and quantity
cor_price_quantity <- cor(x$price, Y)
print(paste("Correlation between price and quantity:", cor_price_quantity))

# Correlation between category and quantity
cor_category_quantity <- cor(x$category, Y)
print(paste("Correlation between category and quantity:", cor_category_quantity))

# Correlation between payment method and quantity
cor_payment_method_quantity <- cor(x$payment_method, Y)
print(paste("Correlation between payment method and quantity:", cor_payment_method_quantity))
